...
PM_DLL_EXPORT void send_data_reliable(intptr_t peer, const char *data, uint32_t length);
PM_DLL_EXPORT void send_data_unreliable(intptr_t peer, const char *data, uint32_t length);
...
PM_DLL_EXPORT unsigned int get_network_delay(intptr_t peer);

PM_DLL_EXPORT void set_kcp_enable(short enable);
